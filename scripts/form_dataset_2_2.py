...
def form_dataset(name_file_dssp):
	...
	for str_ch_2 in group_var_2:
		...
		min_len_loop_sep = temp_df_2['len_loop'].min()
		max_len_loop_sep = temp_df_2['len_loop'].max()
	...
	min_dist_loop_com = result_data['dist_loop'].min()
	max_dist_loop_com = result_data['dist_loop'].max()
